...
export default function Sidebar({ sidebarOpen, setSidebarOpen, onLogoutClick }: SidebarProps) {
  ...
  const adminMenuItems: MenuItem[] = [
    ...
    { key: 'action-tracker', href: '/admin?pg=action-tracker', icon: 'groups', label: 'Action Tracker' },
  ...
  const departmentHeadMenuItems: MenuItem[] = [
    ...
    { key: 'action-tracker', href: '/department-head?pg=action-tracker', icon: 'groups', label: 'Action Tracker', featureKey: HOD_MENU_FEATURE_KEYS['action-tracker'] },
  ...
  const staffMenuItems = [
    ...
    { key: 'action-tracker', href: '/staff?pg=action-tracker', icon: 'groups', label: 'My actions' },
