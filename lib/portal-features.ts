...
export const PORTAL_FEATURE_CATALOG: PortalFeatureDef[] = [
  ...
  { key: 'hod.menu.action-tracker', portal: 'hod', group: 'Side menu', label: 'Action Tracker', defaultEnabled: true, route: { pg: 'action-tracker' } },
...
export const HOD_MENU_FEATURE_KEYS: Record<string, string> = {
  ...
  sds: 'hod.menu.sds',
  'action-tracker': 'hod.menu.action-tracker',
